...
export async function setupFundedTask({
  ...
  await colony.setFundingRole(1, MAX, manager, 1, true);
  await colony.moveFundsBetweenPots(1, MAX, childSkillIndex, 1, task.fundingPotId, totalPayouts, tokenAddress, { from: manager });
