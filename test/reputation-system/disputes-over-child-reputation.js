  ...
  it.skip("dispute should resolve if a bad actor responds on behalf of the good submission omitting some proofs that exist", async () => {
    ...
    repCycle.respondToChallenge(
      [
        ...
        goodClient.justificationHashes[`0x${new BN(lastAgreeIdx).toString(16, 64)}`].nextUpdateProof.nLeaves.toString(),
        agreeStateBranchMask.toString(),
        goodClient.justificationHashes[`0x${new BN(firstDisagreeIdx).toString(16, 64)}`].justUpdatedProof.nLeaves.toString(),
