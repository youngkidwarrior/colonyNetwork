...
contract("Colony Expenditure", accounts => {
  ...
  describe("when adding expenditures", () => {
    ...
    it("should allow arbitration users to transfer expenditures", async () => {
      ...
      await checkErrorRevert(colony.methods[transferSig](1, X, expenditureId, USER, { from: ADMIN }), "ds-auth-unauthorized");
      await colony.methods[transferSig](1, X, expenditureId, USER, { from: ARBITRATOR });
