...
contract("Colony Expenditure", accounts => {
  ...
  describe("when arbitrating expenditures", () => {
    ...
    it("should allow arbitration users to update expenditure status/owner", async () => {
      ...
      await colony.setExpenditureState(1, 0, expenditureId, EXPENDITURES_SLOT, mask, keys, value, { from: ARBITRATOR });
    ...
    it("should not allow arbitration users to update expenditure fundingPotId", async () => {
      ...
      await checkErrorRevert(
        colony.setExpenditureState(1, 0, expenditureId, EXPENDITURES_SLOT, mask, keys, value, { from: ARBITRATOR }),
    ...
    it("should allow arbitration users to update expenditure slot recipient", async () => {
      ...
      await colony.setExpenditureState(1, 0, expenditureId, EXPENDITURESLOTS_SLOT, mask, keys, value, { from: ARBITRATOR });
    ...
    it("should allow arbitration users to update expenditure slot payouts", async () => {
      ...
      await colony.setExpenditureState(1, 0, expenditureId, EXPENDITURESLOTPAYOUTS_SLOT, mask, keys, value, { from: ARBITRATOR });
    ...
    it("should not allow arbitration users to pass invalid slots", async () => {
      ...
      await checkErrorRevert(
        colony.setExpenditureState(1, 0, expenditureId, invalidSlot, mask, keys, value, { from: ARBITRATOR }),
    ...
    it("should not allow arbitration users to pass offsets greater than 1024", async () => {
      ...
      await checkErrorRevert(
        colony.setExpenditureState(1, 0, expenditureId, EXPENDITURESLOTS_SLOT, mask, keys, value, { from: ARBITRATOR }),
