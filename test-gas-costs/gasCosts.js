...
contract("All", function(accounts) {
  ...
  describe("Gas costs", function() {
    ...
    it("when working with a Colony", async function() {
      ...
      await colony.setAdministrationRole(1, MAX, EVALUATOR, 1, true);
    });
    ...
    it("when working with a Task", async function() {
      ...
      await colony.moveFundsBetweenPots(1, MAX, MAX, 1, 2, 190, token.address);
    ...
    it("when working with a Payment", async function() {
      ...
      await colony.addPayment(1, MAX, WORKER, token.address, WAD, 1, 0);
      ...
      await oneTxExtension.makePayment(1, MAX, 1, MAX, WORKER, token.address, 10, 1, GLOBAL_SKILL_ID);
    });
